...
class Ppe_Detection_1():
    ...
    def __init__(self):
        ...
        self.weightfile =  'pi-vehicle-yolov4-tiny-custom_last.weights'
        self.cfgfile =  'pi-vehicle-yolov4-tiny-custom.cfg'
